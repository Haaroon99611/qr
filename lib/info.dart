...
import 'package:registration/camera.dart';
      ...
      body: Center(
        child: Column(
          children: [
            ...
            Text('HAROON MUJTHABA',style: TextStyle(fontSize: 30,fontStyle: FontStyle.italic),),
            ...
            Container(
              ...
              child: TextField(
                decoration: InputDecoration(
                    ...
                    labelText: 'haroonmujthaba99611gmail.com'
                ),
              ),
            ),
            Container(
